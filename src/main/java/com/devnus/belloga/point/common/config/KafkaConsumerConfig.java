...
public class KafkaConsumerConfig {
    ...
    @Bean
    ConcurrentKafkaListenerContainerFactory<String, EventLabeledData.PayTmpPointToLabeler> eventLabeledDataPayTmpPointToLabelerListener(){
        ConcurrentKafkaListenerContainerFactory<String, EventLabeledData.PayTmpPointToLabeler> factory = new ConcurrentKafkaListenerContainerFactory<>();
