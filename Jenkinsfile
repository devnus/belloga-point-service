pipeline {
    ...
    environment {
        ...
        REPOSITORY_URL = 'git@git.swmgit.org:swm-13-main/13_swm56/belloga-point-service.git'
        TARGET_BRANCH = 'master'

        CONTAINER_NAME = 'belloga-point-service'

        SWAGGER_ID = 'belloga-swagger'
        OPEN_API_SPEC_NAME = 'open-api-3-point-service.json'

        AWS_CREDENTIAL_NAME = 'belloga-aws'
        ECR_PATH = '023778162658.dkr.ecr.ap-northeast-2.amazonaws.com'
        IMAGE_NAME = '023778162658.dkr.ecr.ap-northeast-2.amazonaws.com/belloga-point-service'
        ...
        stage('kubectl apply') { // 지금은 apply로 하는데 나중엔 롤링업데이트 하자
            steps {
                ...
                sh """
                    ...
                    kubectl apply -f ./belloga-kube/belloga-point-service.yaml
                    '
                """
                }
            }
